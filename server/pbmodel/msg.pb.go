...
type MsgChat struct {
	...
	KeyPrint     int64         `protobuf:"varint,18,opt,name=keyPrint,proto3" json:"keyPrint,omitempty"`
}
...
type MsgChatQuery struct {
	...
	QueryType string            `protobuf:"bytes,5,opt,name=queryType,proto3" json:"queryType,omitempty"` // data, reply, tag
...
func (x *MsgChatQuery) GetQueryType() string {
	if x != nil {
		return x.QueryType
	}
	return ""
...
func (x *MsgChatQuery) GetParams() map[string]string {
	if x != nil {
		return x.Params
	}
	return nil
...
type MsgChatQueryResult struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	UserId        int64           `protobuf:"varint,1,opt,name=userId,proto3" json:"userId,omitempty"` // 发起人
	ToId          int64           `protobuf:"varint,2,opt,name=toId,proto3" json:"toId,omitempty"`     // 群号
	ChatDataList  []*MsgChat      `protobuf:"bytes,3,rep,name=chatDataList,proto3" json:"chatDataList,omitempty"`
	ChatReplyList []*MsgChatReply `protobuf:"bytes,4,rep,name=chatReplyList,proto3" json:"chatReplyList,omitempty"`
}

func (x *MsgChatQueryResult) Reset() {
	*x = MsgChatQueryResult{}
	if protoimpl.UnsafeEnabled {
...
func (x *MsgChatQueryResult) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MsgChatQueryResult) ProtoMessage() {}

func (x *MsgChatQueryResult) ProtoReflect() protoreflect.Message {
	mi := &file_msg_proto_msgTypes[6]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MsgChatQueryResult.ProtoReflect.Descriptor instead.
func (*MsgChatQueryResult) Descriptor() ([]byte, []int) {
	return file_msg_proto_rawDescGZIP(), []int{6}
}

func (x *MsgChatQueryResult) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *MsgChatQueryResult) GetToId() int64 {
	if x != nil {
		return x.ToId
	}
	return 0
...
func (x *MsgChatQueryResult) GetChatDataList() []*MsgChat {
	if x != nil {
...
func (x *MsgChatQueryResult) GetChatReplyList() []*MsgChatReply {
	if x != nil {
...
func (x *Msg) GetKeyEx() *MsgKeyExchange {
	if x, ok := x.GetMessage().(*Msg_KeyEx); ok {
		return x.KeyEx
	}
	return nil
}
...
func (x *Msg) GetChatQuery() *MsgChatQuery {
	if x, ok := x.GetMessage().(*Msg_ChatQuery); ok {
		return x.ChatQuery
	}
	return nil
}

func (x *Msg) GetChatQueryResult() *MsgChatQueryResult {
	if x, ok := x.GetMessage().(*Msg_ChatQueryResult); ok {
		return x.ChatQueryResult
	}
	return nil
}
...
type Msg_Cipher struct {
	Cipher []byte `protobuf:"bytes,5,opt,name=cipher,proto3,oneof"` // 密文，需要解密后，二次解码
}

type Msg_KeyEx struct {
	KeyEx *MsgKeyExchange `protobuf:"bytes,6,opt,name=keyEx,proto3,oneof"` // 秘钥协商
}
...
type Msg_ChatData struct {
	ChatData *MsgChat `protobuf:"bytes,9,opt,name=chatData,proto3,oneof"` // 聊天消息
}

type Msg_ChatReply struct {
	ChatReply *MsgChatReply `protobuf:"bytes,10,opt,name=chatReply,proto3,oneof"` // 聊天回复消息
}

type Msg_DownloadReq struct {
	DownloadReq *MsgDownloadReq `protobuf:"bytes,11,opt,name=downloadReq,proto3,oneof"` // 下载请求消息
}

type Msg_DownloadReply struct {
	DownloadReply *MsgDownloadReply `protobuf:"bytes,12,opt,name=downloadReply,proto3,oneof"` // 下载回复消息
}

type Msg_UploadReq struct {
	UploadReq *MsgUploadReq `protobuf:"bytes,13,opt,name=uploadReq,proto3,oneof"` // 上传请求消息
}

type Msg_UploadReply struct {
	UploadReply *MsgUploadReply `protobuf:"bytes,14,opt,name=uploadReply,proto3,oneof"` // 上传回复消息
}

type Msg_ChatQuery struct {
	ChatQuery *MsgChatQuery `protobuf:"bytes,15,opt,name=chatQuery,proto3,oneof"` // 查询离线数据，查询状态，关键字搜索
}

type Msg_ChatQueryResult struct {
	ChatQueryResult *MsgChatQueryResult `protobuf:"bytes,16,opt,name=chatQueryResult,proto3,oneof"`
}

type Msg_UserOp struct {
	UserOp *UserOpReq `protobuf:"bytes,17,opt,name=userOp,proto3,oneof"` // 用户操作请求消息
}

type Msg_UserOpRet struct {
	UserOpRet *UserOpResult `protobuf:"bytes,18,opt,name=userOpRet,proto3,oneof"` // 用户操作结果消息
}

type Msg_FriendOp struct {
	FriendOp *FriendOpReq `protobuf:"bytes,19,opt,name=friendOp,proto3,oneof"` // 好友操作请求消息
}

type Msg_FriendOpRet struct {
	FriendOpRet *FriendOpResult `protobuf:"bytes,20,opt,name=friendOpRet,proto3,oneof"` // 好友操作结果消息
}

type Msg_GroupOp struct {
	GroupOp *GroupOpReq `protobuf:"bytes,21,opt,name=groupOp,proto3,oneof"` // 群组操作请求消息
}

type Msg_GroupOpRet struct {
	GroupOpRet *GroupOpResult `protobuf:"bytes,22,opt,name=groupOpRet,proto3,oneof"` // 群组操作结果消息
}

func (*Msg_Cipher) isMsg_Message() {}

func (*Msg_KeyEx) isMsg_Message() {}
...
func (*Msg_ChatQuery) isMsg_Message() {}

func (*Msg_ChatQueryResult) isMsg_Message() {}
...
func (x *MsgPlain) GetChatQuery() *MsgChatQuery {
	if x, ok := x.GetMessage().(*MsgPlain_ChatQuery); ok {
		return x.ChatQuery
	}
	return nil
}

func (x *MsgPlain) GetChatQueryResult() *MsgChatQueryResult {
	if x, ok := x.GetMessage().(*MsgPlain_ChatQueryResult); ok {
		return x.ChatQueryResult
	}
	return nil
}
...
type MsgPlain_ChatQuery struct {
	ChatQuery *MsgChatQuery `protobuf:"bytes,15,opt,name=chatQuery,proto3,oneof"` // 查询离线数据，查询状态，关键字搜索
}

type MsgPlain_ChatQueryResult struct {
	ChatQueryResult *MsgChatQueryResult `protobuf:"bytes,16,opt,name=chatQueryResult,proto3,oneof"`
}
...
func (*MsgPlain_ChatQuery) isMsgPlain_Message() {}

func (*MsgPlain_ChatQueryResult) isMsgPlain_Message() {}
...
var file_msg_proto_rawDesc = []byte{
	...
	0x65, 0x6c, 0x1a, 0x0a, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x9a,
	...
	0x61, 0x67, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x6b, 0x65, 0x79, 0x50, 0x72, 0x69, 0x6e, 0x74, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x6b, 0x65, 0x79, 0x50, 0x72, 0x69, 0x6e, 0x74, 0x12,
	0x1a, 0x0a, 0x08, 0x72, 0x73, 0x61, 0x50, 0x72, 0x69, 0x6e, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x08, 0x72, 0x73, 0x61, 0x50, 0x72, 0x69, 0x6e, 0x74, 0x12, 0x33, 0x0a, 0x06, 0x70,
	0x61, 0x72, 0x61, 0x6d, 0x73, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x6d, 0x6f,
	0x64, 0x65, 0x6c, 0x2e, 0x4d, 0x73, 0x67, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x2e, 0x50, 0x61, 0x72,
	...
	0x4d, 0x73, 0x67, 0x4b, 0x65, 0x79, 0x45, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x1a,
	0x0a, 0x08, 0x6b, 0x65, 0x79, 0x50, 0x72, 0x69, 0x6e, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x08, 0x6b, 0x65, 0x79, 0x50, 0x72, 0x69, 0x6e, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x72, 0x73,
	0x61, 0x50, 0x72, 0x69, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x72, 0x73,
	...
	0x52, 0x06, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x22, 0x36, 0x0a, 0x0c, 0x4d, 0x73, 0x67, 0x48,
	0x65, 0x61, 0x72, 0x74, 0x42, 0x65, 0x61, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x74, 0x6d, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x74, 0x6d, 0x12, 0x16, 0x0a, 0x06, 0x75, 0x73, 0x65, 0x72,
	0x49, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64,
	0x22, 0xa5, 0x04, 0x0a, 0x07, 0x4d, 0x73, 0x67, 0x43, 0x68, 0x61, 0x74, 0x12, 0x14, 0x0a, 0x05,
	...
	0x28, 0x03, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06, 0x66, 0x72,
	...
	0x52, 0x04, 0x74, 0x6f, 0x49, 0x64, 0x12, 0x0e, 0x0a, 0x02, 0x74, 0x6d, 0x18, 0x05, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x02, 0x74, 0x6d, 0x12, 0x14, 0x0a, 0x05, 0x64, 0x65, 0x76, 0x49, 0x64, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x64, 0x65, 0x76, 0x49, 0x64, 0x12, 0x16, 0x0a, 0x06,
	0x73, 0x65, 0x6e, 0x64, 0x49, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x73, 0x65,
	...
	,
	...
	,
	...
	0x01, 0x0a, 0x12, 0x4d, 0x73, 0x67, 0x43, 0x68, 0x61, 0x74, 0x51, 0x75, 0x65, 0x72, 0x79, 0x52,
	...
	,
	...
	,
	...
	0x03, 0x52, 0x06, 0x6f, 0x66, 0x66, 0x73, 0x65, 0x74, 0x22, 0xf6, 0x01, 0x0a, 0x10, 0x4d, 0x73,
	0x67, 0x44, 0x6f, 0x77, 0x6e, 0x6c, 0x6f, 0x61, 0x64, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x16,
	0x0a, 0x06, 0x73, 0x65, 0x6e, 0x64, 0x49, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	0x73, 0x65, 0x6e, 0x64, 0x49, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x4e, 0x61,
	...
	0x0a, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x54, 0x79, 0x70, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x08, 0x66, 0x69, 0x6c, 0x65, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x68, 0x61,
	0x73, 0x68, 0x54, 0x79, 0x70, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x68, 0x61,
	0x73, 0x68, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x68, 0x61, 0x73, 0x68, 0x43, 0x6f,
	0x64, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x08, 0x68, 0x61, 0x73, 0x68, 0x43, 0x6f,
	0x64, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0c,
	0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x12, 0x0a, 0x04, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x08,
	...
	,
	...
	,
...
var file_msg_proto_goTypes = []interface{}{
	...
	(*MsgKeyExchange)(nil),     // 6: model.MsgKeyExchange
	(*MsgHeartBeat)(nil),       // 7: model.MsgHeartBeat
	(*MsgChat)(nil),            // 8: model.MsgChat
	(*MsgChatReply)(nil),       // 9: model.MsgChatReply
	(*MsgChatQuery)(nil),       // 10: model.MsgChatQuery
	(*MsgChatQueryResult)(nil), // 11: model.MsgChatQueryResult
	(*MsgUploadReq)(nil),       // 12: model.MsgUploadReq
	(*MsgUploadReply)(nil),     // 13: model.MsgUploadReply
	(*MsgDownloadReq)(nil),     // 14: model.MsgDownloadReq
	(*MsgDownloadReply)(nil),   // 15: model.MsgDownloadReply
	(*Msg)(nil),                // 16: model.Msg
	(*MsgPlain)(nil),           // 17: model.MsgPlain
	nil,                        // 18: model.MsgHello.ParamsEntry
	nil,                        // 19: model.MsgChatQuery.ParamsEntry
	(*UserOpReq)(nil),          // 20: model.UserOpReq
	(*UserOpResult)(nil),       // 21: model.UserOpResult
	(*FriendOpReq)(nil),        // 22: model.FriendOpReq
	(*FriendOpResult)(nil),     // 23: model.FriendOpResult
	(*GroupOpReq)(nil),         // 24: model.GroupOpReq
	(*GroupOpResult)(nil),      // 25: model.GroupOpResult
}
var file_msg_proto_depIdxs = []int32{
	18, // 0: model.MsgHello.params:type_name -> model.MsgHello.ParamsEntry
	...
	19, // 5: model.MsgChatQuery.params:type_name -> model.MsgChatQuery.ParamsEntry
	8,  // 6: model.MsgChatQueryResult.chatDataList:type_name -> model.MsgChat
	9,  // 7: model.MsgChatQueryResult.chatReplyList:type_name -> model.MsgChatReply
	0,  // 8: model.Msg.msgType:type_name -> model.ComMsgType
	6,  // 9: model.Msg.keyEx:type_name -> model.MsgKeyExchange
	5,  // 10: model.Msg.hello:type_name -> model.MsgHello
	7,  // 11: model.Msg.heartBeat:type_name -> model.MsgHeartBeat
	8,  // 12: model.Msg.chatData:type_name -> model.MsgChat
	9,  // 13: model.Msg.chatReply:type_name -> model.MsgChatReply
	14, // 14: model.Msg.downloadReq:type_name -> model.MsgDownloadReq
	15, // 15: model.Msg.downloadReply:type_name -> model.MsgDownloadReply
	12, // 16: model.Msg.uploadReq:type_name -> model.MsgUploadReq
	13, // 17: model.Msg.uploadReply:type_name -> model.MsgUploadReply
	10, // 18: model.Msg.chatQuery:type_name -> model.MsgChatQuery
	11, // 19: model.Msg.chatQueryResult:type_name -> model.MsgChatQueryResult
	20, // 20: model.Msg.userOp:type_name -> model.UserOpReq
	21, // 21: model.Msg.userOpRet:type_name -> model.UserOpResult
	22, // 22: model.Msg.friendOp:type_name -> model.FriendOpReq
	23, // 23: model.Msg.friendOpRet:type_name -> model.FriendOpResult
	24, // 24: model.Msg.groupOp:type_name -> model.GroupOpReq
	25, // 25: model.Msg.groupOpRet:type_name -> model.GroupOpResult
	5,  // 26: model.MsgPlain.hello:type_name -> model.MsgHello
	7,  // 27: model.MsgPlain.heartBeat:type_name -> model.MsgHeartBeat
	8,  // 28: model.MsgPlain.chatData:type_name -> model.MsgChat
	9,  // 29: model.MsgPlain.chatReply:type_name -> model.MsgChatReply
	14, // 30: model.MsgPlain.downloadReq:type_name -> model.MsgDownloadReq
	15, // 31: model.MsgPlain.downloadReply:type_name -> model.MsgDownloadReply
	12, // 32: model.MsgPlain.uploadReq:type_name -> model.MsgUploadReq
	13, // 33: model.MsgPlain.uploadReply:type_name -> model.MsgUploadReply
	10, // 34: model.MsgPlain.chatQuery:type_name -> model.MsgChatQuery
	11, // 35: model.MsgPlain.chatQueryResult:type_name -> model.MsgChatQueryResult
	20, // 36: model.MsgPlain.userOp:type_name -> model.UserOpReq
	21, // 37: model.MsgPlain.userOpRet:type_name -> model.UserOpResult
	22, // 38: model.MsgPlain.friendOp:type_name -> model.FriendOpReq
	23, // 39: model.MsgPlain.friendOpRet:type_name -> model.FriendOpResult
	24, // 40: model.MsgPlain.groupOp:type_name -> model.GroupOpReq
	25, // 41: model.MsgPlain.groupOpRet:type_name -> model.GroupOpResult
	16, // 42: model.MsgService.ClientEvent:input_type -> model.Msg
	16, // 43: model.MsgService.ClientEvent:output_type -> model.Msg
...
func file_msg_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_msg_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MsgChatQueryResult); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_msg_proto_msgTypes[11].OneofWrappers = []interface{}{
		(*Msg_Cipher)(nil),
		(*Msg_KeyEx)(nil),
		(*Msg_Hello)(nil),
		(*Msg_HeartBeat)(nil),
	...
	file_msg_proto_msgTypes[12].OneofWrappers = []interface{}{
		...
		(*MsgPlain_ChatQuery)(nil),
		(*MsgPlain_ChatQueryResult)(nil),
		(*MsgPlain_UserOp)(nil),
